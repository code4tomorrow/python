...
#rect[0] = rect color; rect[1] = x-coord; rect[2] = y-coord; rect[3] = width; rect[4] = height
...
while run:
    ...
    screen.fill(white)
    #draw rect
    pygame.draw.rect(screen, rectangle[0], pygame.Rect(rectangle[1], rectangle[2], rectangle[3], rectangle[4]))
    #Check events
