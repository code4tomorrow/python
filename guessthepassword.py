#Directions: The goal of this exercise is to create a game where the user has to guess a 
certain password that you set and see how many tries it takes for that user to guess correctly
...
print("Nice Job. Unlocked. It took you " + str(counter)+ " tries")
