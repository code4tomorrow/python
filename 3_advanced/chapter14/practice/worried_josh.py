...
and “NO :(“ if he doesn’t. Assume n will not be greater than the number of
students. Use enumerate to solve this problem.
"""

# the list of student names is given and the n is a user input
# remember the
# leftmost student = highest score, rightmost student = lowest score
students = ["Dan", "Isaac", "Jo", "Josh", "Dennis", "Erwin", "Ivan", "Penny"]
n = int(input())
