...
# Depending on what IDE you are using, you may have to use
# bob.mainloop() if a window with an arrow doesn’t pop up.
...
# -Turn left 60 degrees.
# -Draw a Koch curve with length x/3.
# However, if x<3, you will just move bob(the turtle) forward
# by length x
