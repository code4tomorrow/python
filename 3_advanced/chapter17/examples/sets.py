...
print(
    oursuperset.issuperset(oursubset)
)  # should print True since oursuperset has 1,5, and 3
print(
    oursubset.issubset(oursuperset)
)  # should print True since oursuperset has 1,5, and 3
print(
    oursubset.issuperset(oursuperset)
...
a_set.discard(
    9
)  # removes 9; if 9 isn't there, don't raise an error (do nothing)
