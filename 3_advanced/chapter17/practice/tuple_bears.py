# Fred had lost his teddy bear, so his parents are going to the store to buy a replacement for him.
# You are given a list of length 2(2 elements) tuples, where each tuple represents a teddy bear.
# Where the first element contains a number showing how similar that that bear is to Fred's original
